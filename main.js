...
class CrewMember {
  ...
  enterShip = (shipOb) => {
    this.ship = shipOb;
    shipOb.crew.push(this);
    return shipOb.missionStatement;
  };
}

// const crewMember1 = new CrewMember("Rick Martinez", "pilot", "chemistry");
// console.log(crewMember1);
// crewMember1.ship = "BRUV";
// crewMember1.enterShip("BRUH");
// console.log(crewMember1);
...
if (typeof describe === "function") {
  describe("CrewMember", function () {
    ...
    it("can enter a ship", function () {
      ...
      const crewMember1 = new CrewMember("Rick Martinez", "pilot", "chemistry");
      crewMember1.enterShip(mav);
      // need to create an enterShip() method of CrewMember that allows crew member to enter ship
      // presumably this also assigns crewMember.ship = mav in this scenario.
